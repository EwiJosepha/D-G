...
const DescriptionPagee: React.FC<DescriptionPageProps> = ({ }: DescriptionPageProps) => {
            ...
            <div className="bg-black text-white rounded shadow-md p-8">
              ...
              <div className="flex flex-wrap">
                <div className="w-full border-t border-gray-600 flex items-center sm:w-1/2 p-4">
                  ...
                  <p className="text-lg font-semibold">{dataFromQuery?.rooms}</p>
                </div>
                <div className="w-full border-t border-gray-600 flex items-center sm:w-1/2 p-4">
                  <p className="mr-4">Number of Baths:</p>
                  <p className="text-lg font-semibold">{dataFromQuery?.bath}</p>
                </div>
                <div className="w-full border-t border-gray-600 flex items-center sm:w-1/2 p-4">
                  <p className="mr-4">Living Room:</p>
                  <p className="text-lg font-semibold">{dataFromQuery?.livingRooms}</p>
                </div>
                <div className="w-full border-t border-gray-600 flex items-center sm:w-1/2 p-4">
                  <p className="mr-4">Status:</p>
                  <p className="text-lg font-semibold">{dataFromQuery?.rentOrSale}</p>
                </div>
                <div className="w-full border-t border-gray-600 flex items-center sm:w-1/2 p-4">
